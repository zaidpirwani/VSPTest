...
namespace VSPTest_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(EjaadTech.VSPTest.GuidList.guidVSPTestCmdSet, (int)EjaadTech.VSPTest.PkgCmdIDList.testCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "VSPTest", "EjaadTech.VSPTest.VSPTestPackage");
