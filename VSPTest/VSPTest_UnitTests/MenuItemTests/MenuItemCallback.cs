...
using EjaadTech.VSPTest;

namespace VSPTest_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSPTestPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(EjaadTech.VSPTest.GuidList.guidVSPTestCmdSet, (int)EjaadTech.VSPTest.PkgCmdIDList.testCommand);
